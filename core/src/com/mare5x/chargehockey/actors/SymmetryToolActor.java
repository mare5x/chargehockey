...
public class SymmetryToolActor extends Actor {
    ...
    /** Orthogonal projection of pos coordinates to the perpendicular axis. */
    private Vector2 orthogonal_projection(Vector2 pos) {
        float eps = (getRotation() - 90) * MathUtils.degreesToRadians;
        float k1 = (float) Math.tan(eps);
        float k2 = -1 / k1;
